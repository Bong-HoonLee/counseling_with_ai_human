...
from .settings import QdrantClintConfig, QdrantVsConfig, QdrantCollectionParams
from app.domain.models import PointUpsert
...
class Qdrant:
    ...
    def create_index(self, schema: QdrantCollectionParams = None) -> None:
        '''
